...
struct MyProgram {
    ...
    MyProgram(const FilePath& applicationPath): 
        ...
        uLightDir = glGetUniformLocation(id, "uLightDir_vs");
...
int main(int argc, char** argv) {
    ...
    while(!done) {
        ...
        glUniform3fv(myProgram.uLightDir, 1, glm::value_ptr(
        	glm::vec3(ViewMatrix * glm::rotate(glm::mat4(1), timer, glm::vec3(0, 1, 0)) * glm::vec4(1, 1, 1, 0))
        ));
        ...
        ModelMatrix = glm::translate(glm::mat4(4), glm::vec3(0, 0, -5));
        ModelMatrix = glm::rotate(ModelMatrix, - 10 * timer, glm::vec3(0, 1, 0));
